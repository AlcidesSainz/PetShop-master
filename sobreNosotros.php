...
<body>
    ...
    <div class="row container">
        <div class="col-7 mt-5 mb-5">
            <img class="img-fluid" src="img/about us/aboutus.jpg" alt=""
                style="width: 700px; border: 2px solid black; border-radius: 660px;">
            <img class="img-fluid mt-5" src="img/about us/abouts2.jpg"
                style="width: 700px; border: 2px solid black; border-radius: 660px;" alt="">
        </div>
        <div class="col-5 sobre-nosotros mt-5 mb-5 container ">
    ...
    <div class="row text-center container-contact">
        <div class="col-md-4">
            <span><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-telephone"
                    viewBox="0 0 16 16">
                    <path
