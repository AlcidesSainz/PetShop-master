...
<body>
  ...
  <div class="container mt-5 container-servicios">
    <div class="row justify-content-center">
      ...
      <div class="col-md-3 container-service">
        <div class="image-container text-center">
          <svg xmlns="http://www.w3.org/2000/svg" fill="rgb(81, 117, 99)" class="bi bi-hourglass-split" viewBox="0 0 16 16">
    ...
    <div class="row">
      ...
      <div class="mb-3 col-lg-6">
        ...
        <div class="form-floating mb-3">
          <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2E" style="height: 100px; width: 625px"></textarea>
  ...
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD4tpSjs5JX1kBLs2J6lhjMyAu4zPitQP0&callback=inicializarMapa" async defer></script>
